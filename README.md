...
The Jupyter Notebooks in this repository can be used in Google Colab or locally. If you are interested in running this locally, make sure to install the latest version of (python.org/downloads)[Python] that is (https://pytorch.org/get-started/locally/)[compatible with PyTorch] and the necessary libraries:
